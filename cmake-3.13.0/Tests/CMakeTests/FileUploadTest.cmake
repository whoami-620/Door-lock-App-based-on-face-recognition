file(REMOVE_RECURSE "/home/pi/cmake-3.13.0/Tests/CMakeTests/uploads")

if(EXISTS "/home/pi/cmake-3.13.0/Tests/CMakeTests/uploads/file1.png")
  message(FATAL_ERROR "error: file1.png exists - should have been deleted")
endif()
if(EXISTS "/home/pi/cmake-3.13.0/Tests/CMakeTests/uploads/file2.png")
  message(FATAL_ERROR "error: file2.png exists - should have been deleted")
endif()

file(MAKE_DIRECTORY "/home/pi/cmake-3.13.0/Tests/CMakeTests/uploads")

set(filename "/home/pi/cmake-3.13.0/Tests/CMakeTests/FileDownloadInput.png")
if(NOT "/home/pi/cmake-3.13.0/Tests/CMakeTests" MATCHES "^/")
  set(slash /)
endif()
set(urlbase "file://${slash}/home/pi/cmake-3.13.0/Tests/CMakeTests/uploads")
...
execute_process(COMMAND ${CMAKE_COMMAND} -E md5sum
  "/home/pi/cmake-3.13.0/Tests/CMakeTests/uploads/file1.png"
...
execute_process(COMMAND ${CMAKE_COMMAND} -E md5sum
  "/home/pi/cmake-3.13.0/Tests/CMakeTests/uploads/file2.png"
